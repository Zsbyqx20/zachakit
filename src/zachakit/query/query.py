...
def parse_args():
    ...
    parser.add_argument(
        ...
        required=True,
        type=str,
        help="Directory containing json line files used for query.",
    )
    parser.add_argument(
        "-o",
        "--output-dir",
        required=True,
        type=str,
        help="Directory to save result json line files.",
    )
    parser.add_argument(
        "--model-name",
        type=str,
        default="gpt-3.5-turbo-1106",
        help="OpenAI model name used for query.",
    )
    parser.add_argument(
        "--client",
        type=str,
